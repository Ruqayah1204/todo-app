...
// import { useTodoById } from "../hooks/useTodoList";
// import { useParams, useNavigate } from "react-router-dom";
// import { SkeletonLoading } from "@/components/ui/skeleton";
// import { Button } from "./ui/button";
// import { Card, CardContent } from "@/components/ui/card";
// import { ArrowLeft } from "lucide-react";
// import Modal from "./Modal";
// import { useUpdateTodo } from "../hooks/useTodoList";
...
//   const { id } = useParams();
//   // const numericId = Number(id);
//   const { data, isLoading, error } = useTodoById(id);
...
//     const formData = new FormData(e.target);
//     const updatedTodo = formData.get("todo");
...
//               <p className="italic text-xl text-center"> No task available</p>
//             )}
//             <h2 className="font-medium text-xl">Title: {data.todo}</h2>
//             <p className="text-gray-500 italic">No descrition available</p>
//             <p
//               className={`${
//                 data.completed ? "bg-green-500/50" : "bg-chart-1/50"
//               } p-2 rounded-lg`}
//               aria-live="polite"
//             >
...
//             <div className="flex justify-between gap-4 items-center">
//               <Button onClick={handleGoBack} className="bg-blue-primary hover:bg-blue-secondary/90" aria-label="Go Back">
//                 <ArrowLeft /> Go back
//               </Button>
//               <Modal task={data} onSubmit={handleSubmit}/>
//               {/* <Button className="bg-green-600" aria-label="Edit task">Edit Task</Button> */}
